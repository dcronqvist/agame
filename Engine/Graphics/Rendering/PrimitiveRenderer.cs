...
namespace AGame.Engine.Graphics.Rendering
{
    ...
    public class PrimitiveRenderer
    {
        ...
        private uint circVAO;
        private uint circVBO;

        public PrimitiveRenderer(Shader shader)
        {
            this.shader = shader;
            WireFrameMode = false;
        ...
        public unsafe void InitRectangleRenderData()
        {
        ...
        public unsafe void RenderRectangle(RectangleF rectangle, ColorF color)
        {
            RenderRectangle(rectangle, color, color);
        }

        public unsafe void RenderRectangle(RectangleF rectangle, ColorF left, ColorF right)
        {
            RenderRectangle(rectangle, 0f, left, right, left, right);
        }

        public unsafe void RenderRectangle(RectangleF rectangle, ColorF color, float rotation)
        {
            RenderRectangle(rectangle, rotation, color, color, color, color);
        }

        public unsafe void RenderRectangle(RectangleF rectangle, float rotation, ColorF colorTopLeft, ColorF colorTopRight, ColorF colorDownLeft, ColorF colorDownRight)
        {
        ...
        public unsafe void RenderLine(Vector2 start, Vector2 end, int width, ColorF color)
        {
            RenderLine(start, end, width, color, color);
        }

        public unsafe void RenderLine(Vector2 start, Vector2 end, int width, ColorF startCol, ColorF endCol)
        {
            ...
            RenderRectangle(rec, rotation, startCol, endCol, startCol, endCol);
        }

        public unsafe void InitCircleRenderData()
        {
        ...
        private Vector2[] GenerateCirclePoints(int numSamplePoints)
        {
        ...
        private ColorF[] CreateColorArray(ColorF color)
        {
        ...
        public unsafe void RenderCircle(Vector2 position, float radius, ColorF color, bool useFalloff)
        {
            RenderCircle(position, radius, CreateColorArray(color), useFalloff);
        }

        public unsafe void RenderCircle(Vector2 position, float radius, ColorF[] colorPoints, bool useFalloff)
        {
            shader.Use();
