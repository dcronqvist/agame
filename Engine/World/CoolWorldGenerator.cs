...
public class CoolWorldGenerator : IWorldGenerator
{
    ...
    public List<EntityDistributionDefinition> GetEntityDistributionDefinitions()
    {
        ...
        {
            new EntityDistributionDefinition("default.entity.ore_rock", 0.08f, 4f, "default.script_class.distributor_circles"),
            new EntityDistributionDefinition("default.entity.test_rock", 0.08f, 1f, "default.script_class.distributor_squares")
    };
    }
}