...
//         if (entity.TryGetComponent<ShadowComponent>(out var shadow))
//         {
//             float radius = MathF.Max(shadow.Radius - (transform.HeightAboveGround * 0.25f), 0.05f);
//             float opacity = shadow.Opacity;

//             var position = transform.Position.ToWorldVector().ToVector2() + render.FeetOffset;
//             var color = ColorF.Black * opacity;
//             Renderer.Primitive.RenderCircle(position, radius, color, true);
//         }
...
//             animator.GetAnimator().Render(transform.Position.ToWorldVector().ToVector2().Offset(new Vector2(0, -transform.HeightAboveGround)), ColorF.White);
//         }
...
//             sprite.GetSprite().Render(transform.Position.ToWorldVector().ToVector2().Offset(new Vector2(0, -transform.HeightAboveGround)));
//         }
...
//             Renderer.Texture.Render(item.GetTexture(), transform.Position.ToWorldVector().ToVector2().Offset(new Vector2(0, -transform.HeightAboveGround)), Vector2.One * 2f, 0f, ColorF.White);
//         }
